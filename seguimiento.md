...
- [ ] Conversión USD → DOP (depende de Ingresos, ya listo)
...
- Implementación: 50% (base de datos + backend NestJS + autenticación + módulo de Ingresos + frontend con login y registro funcionales; falta dashboard real y el resto de módulos de negocio)

## Próximos pasos
1. Conversión USD → DOP (siguiente en el roadmap, depende de Ingresos).
2. Módulo de Pagos Recurrentes.
